...
amount:210},{name:"Racing",amount:202},{name:"Adventure",amount:196}];c.x=18;c.textData={};c.tagLimit=8;c.showAllTags=!1;c.availableLangs=["en","es","no"];window.location.href.includes("lang=")&&(c.lang=window.location.href.replace(/.+lang=/,""));c.lang=-1<c.availableLangs.indexOf(c.lang)?c.lang:"en";c.allGamesAreDisplayed=function(){return c.games.length<c.x?!1:!0};q.json.then(function(a){Array.prototype.push.apply(c.games,a.initialGames);c.verifiedUser=a.verifiedUser;c.tags=a.topTags;c.x=a.count});
c.requestGames=function(a){r||c.allGamesAreDisplayed()||(r=!0,a=t.getGames+"?from="+c.games.length+"&amount="+a+"&d="+Math.floor(Date.now()/36E5),0<q.pass.length&&(a+="&pass="+q.pass),p.get(a,1400).then(function(a){Array.prototype.push.apply(c.games,a.data);r=!1})["catch"](function(a,b){console.log(a,b);r=!1}))};c.rate=function(a,b){};c.like=function(a){c.rate(a,"like",1)};c.dislike=function(a){c.rate(a,"dislike",-1)};c.ifDisabled=function(){return c.disabled};c.locChangeAlert="Please don't leave the page until the server has responded";
"no"===c.lang&&(c.locChangeAlert="Vennligst ikke forlat siden f\u00f8r serveren har svart");"es"===c.lang&&(c.locChangeAlert="Por favor no salgas de la pagina hasta que el servidor responda");d.$on("$locationChangeStart",function(a){c.disabled&&(a.preventDefault(),alert(c.locChangeAlert))});f.onbeforeunload=function(){if(c.disabled)return locChangeAlert};c.css="";c.mlcLoaded=!1;c.lazyModulesLoaded=!1;d.$on("$routeChangeSuccess",function(a){try{f.ga("send","pageview",{page:h.url()})}catch(l){}});p.get("min/lazy-js.min.js",
2E3).then(function(a){eval(a);c.lazyModulesLoaded=!0});/bot|curl|spider|google|twitter^$/i.test(navigator.userAgent)||p.get("src/js/scripts/analytics.js",0).then(function(a){eval(a)});p.get("src/js/objects/"+c.lang+"-text.json").then(function(a){c.textData=a})["catch"](function(a,b){console.log(a,b);confirm("Unable to load textdata, do you want to reload the page?")?location.reload(!0):null})}]);app.controller("categoryCtrl",["$http","$routeParams","$scope","urls","initialJSON","$lhttp",function(a,f,d,g,e,h){var b=this,m=!1;b.tag=f.category;b.amount=1;b.noGames=!1;d.master.loc="Thorin-Games \u2014 "+b.tag;d.master.desc=d.master.norsk?"Here you can find all our games with the tag "+b.tag+" sorted by popularity":'Her kan du finne alle v\u00e5re spill med taggen "'+b.tag+'" sortert etter popularitet';b.games=b.tag in d.master.categoryGames?b.games=d.master.categoryGames[b.tag]:[];h.get(g.countGames+
