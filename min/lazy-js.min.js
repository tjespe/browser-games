console.log("Executing scroll.js");app.directive("scroll",["$window","initialJSON",function(e,b){console.log("Executing scroll directive");return function(a){var f=function(){b.jquery.then(function(){$("#games").length&&this.pageYOffset>=$("#games").outerHeight()-2E3&&(void 0!==a.cat?a.cat.requestGames(18):a.master.requestGames(18))})};angular.element(e).on("scroll",f);a.$on("$destroy",function(){angular.element(e).off("scroll",f)})}}]);app.controller("lazyStuff",["$http","$scope","local","$location","$routeParams","$lhttp","urls",function(e,b,a,f,g,h,c){function k(d,a){h.get("//static.thorin-games.tk"+a,0).then(function(d){b.master.css+=d})}b.master.rate=function(d,a,f){b.master.disabled||(b.master.disabled=!0,Date.now(),a=e({method:"get",url:c.rating+"?action="+a+"&id="+d,data:d,headers:{"Content-Type":"application/x-www-form-url-encoded"}}),a.success(function(a){Date.now();console.log(a.logdata);document.getElementById(d).innerHTML=
1*document.getElementById(d).innerHTML+f;b.master.disabled=!1}),a.error(function(a){document.getElementById(d).innerHTML="ERROR "+a;b.master.disabled=!1}))};b.master.disabled=!1;var d=b.master;d.toggleTags=function(){d.showAllTags=!d.showAllTags};d.search=function(){f.path("tag/"+d.otag);d.collapseTags()};d.goTo=function(a){f.path(a);d.collapseTags()};d.goToGame=function(a){f.path("id/"+a)};d.goHome=function(){f.path("");d.collapseTags()};d.collapseTags=function(){d.showAllTags=!1};d.ifHome=function(){return"/"==
f.path()};d.ifAtSubmit=function(){return"/submit"==f.path()};d.ifAt=function(a){return f.path()==a};d.tagIs=function(a){return"undefined"!=typeof g.category?g.category.toLowerCase()==a.toLowerCase():!1};for(var l in d)b.master[l]=d[l];k("ubuntu","/css/ubuntu.php");k("glyphs","/custom_bootstrap/css/glyphicons.php");k("listGroups","/custom_bootstrap/css/list-groups.php");b.master.mlcLoaded=!0}]);app.controller("cookieCtrl",["$timeout",function(e){function b(a,b){return(b=document.cookie.match("(^|;)\\s*"+a+"\\s*=\\s*([^;]+)"))?b.pop():""}var a=this;a.template="";a.close=function(){$(".cookie-box").css("opacity",0);e(function(){$(".cookie-box").remove()},500);"undefined"!==typeof Storage?localStorage.cookieAccept="true":document.cookie="cookiescriptaccept=visit"};"undefined"!==typeof Storage&&"true"!=localStorage.cookieAccept&&"visit"!=b("cookiescriptaccept")?e(function(){document.getElementsByClassName("cookie-box")[0].setAttribute("style",
"opacity:1;");e(a.close,5E3)},2500):document.querySelector("#cookies").remove()}]);console.log("Executing mailListCtrl.js");
