console.log("Executing scroll.js");app.directive("scroll",["$window","initialJSON",function(e,b){console.log("Executing scroll directive");return function(a){var f=function(){b.jquery.then(function(){$("#games").length&&this.pageYOffset>=$("#games").outerHeight()-2E3&&(void 0!==a.cat?a.cat.requestGames(18):a.master.requestGames(18))})};angular.element(e).on("scroll",f);a.$on("$destroy",function(){angular.element(e).off("scroll",f)})}}]);app.controller("lazyStuff",["$http","$scope","local","$location","$routeParams","$lhttp","urls",function(e,b,a,f,g,h,l){function c(a,c){h.get("/src/css/"+c,0).then(function(c){b.master.css+=c})}b.master.rate=function(c,a,d){b.master.disabled||(b.master.disabled=!0,Date.now(),a=e({method:"get",url:l.rating+"?action="+a+"&id="+c}),a.success(function(a){Date.now();console.log(a.logdata);document.getElementById(c).innerHTML=a.data;b.master.disabled=!1}),a.error(function(a){document.getElementById(c).innerHTML=
"ERROR "+a;b.master.disabled=!1}))};b.master.disabled=!1;var d=b.master;d.toggleTags=function(){d.showAllTags=!d.showAllTags};d.search=function(){f.path("tag/"+d.otag);d.collapseTags()};d.goTo=function(a){f.path(a);d.collapseTags()};d.goToGame=function(a){f.path("id/"+a)};d.goHome=function(){f.path("");d.collapseTags()};d.collapseTags=function(){d.showAllTags=!1};d.ifHome=function(){return"/"==f.path()};d.ifAtSubmit=function(){return"/submit"==f.path()};d.ifAt=function(a){return f.path()==a};d.tagIs=
function(a){return"undefined"!=typeof g.category?g.category.toLowerCase()==a.toLowerCase():!1};for(var k in d)try{b.master[k]=d[k]}catch(m){console.warn(m)}c("ubuntu","ubuntu.css");c("glyphs","custom_bootstrap/glyphicons.min.css");c("listGroups","custom_bootstrap/list-groups.min.css");b.master.mlcLoaded=!0}]);app.controller("cookieCtrl",["$timeout",function(e){function b(a,b){return(b=document.cookie.match("(^|;)\\s*"+a+"\\s*=\\s*([^;]+)"))?b.pop():""}var a=this;a.template="";a.close=function(){$(".cookie-box").css("opacity",0);e(function(){$(".cookie-box").remove()},500);"undefined"!==typeof Storage?localStorage.cookieAccept="true":document.cookie="cookiescriptaccept=visit"};"undefined"!==typeof Storage&&"true"!=localStorage.cookieAccept&&"visit"!=b("cookiescriptaccept")?e(function(){try{document.getElementsByClassName("cookie-box")[0].setAttribute("style",
"opacity:1;")}catch(f){console.warn(f)}e(a.close,5E3)},2500):document.querySelector("#cookies").remove()}]);app.controller("submitCtrl",["$http","$scope","initialJSON","urls",function(e,b,a,f){function g(a){return a.replace(/\w\S*/g,function(a){return a.charAt(0).toUpperCase()+a.substr(1).toLowerCase()})}function h(a){if(0<a.length){a=a.match(/#[^#]+/g);for(i=0;i<a.length;i++)try{a[i]=a[i].replace("#",""),a[i]=a[i].trim(),a[i]=g(a[i])}catch(m){console.warn(m)}return a}return[]}function l(a){var c=[],b;for(b in a)a.hasOwnProperty(b)?c.push(encodeURIComponent(b)+"="+encodeURIComponent(a[b])):null;return c.join("&")}
var c=this;b.master.loc="Thorin-Games \u2014 Submit a game";b.master.desc="If you want to, you can submit a game to Thorin-Games, all you have to do is to fill out the form below and tap submit";b.master.norsk&&(b.master.loc="Thorin-Games \u2014 Legg til et spill",b.master.desc="Dersom du \u00f8nsker det kan du legge til et spill til Thorin-Games. Alt du m\u00e5 gj\u00f8re er \u00e5 fylle ut skjemaet nedenfor og trykke legg til.");c.tagValReg=/.*#.+/i;c.game={title:"",comments:[],likes:2,height:"n",
width:"100%","public":!0,instructions:"",tags:[],thumbnail:"",file:"",description:"",mobile:!1};c.gameTags="";c.gameHeight="";c.gameWidth="";c.showPreview=!1;c.loading=!1;c.success=!1;c.errors={EMBED_ERROR:!1,IMAGE_ERROR:!1,DESC_ERROR:!1,MISSING_KEYS:[],OTHER_ERROR:!1};c.showP=function(){c.showPreview=!0};var d=function(a){return/^\d+$/.test(a)||"n"==a||"r"==a||/[0-9]*px$/.test(a)||/[0-9]*%$/.test(a)};c.submit=function(){d(c.gameHeight)&&d(c.gameWidth)&&(c.game.height=c.gameHeight,c.game.width=c.gameWidth);
c.game.tags=h(c.gameTags);console.log("Spillet fikk disse taggene:",c.game.tags,"hele objektet ser slik ut:",c.game);console.log(b);if(c.submitGame.$valid){console.log("Alt ser bra ut, spillet kan lastes opp");c.loading=!0;var a=e({method:"get",url:f.submitGame+"?"+l(c.data)});a.success(function(a){console.log(a);c.showPreview=!1;c.loading=!1;c.errors=a.errors;if(c.success=a.success)c.game={title:"",comments:[],likes:2,height:"n",width:"100%","public":!0,instructions:"",tags:[],thumbnail:"",file:"",
description:""},c.showPreview=!1});a.error(function(a,b){c.errors.OTHER_ERROR=!0;c.loading=!1;console.log("Data:",a,"status:",b)})}};c.init=function(){console.log("initialized");a.jquery.then(function(){$("textarea").each(function(a){$(this).attr("rows",Math.ceil($(this).attr("placeholder").length*(430/56)/$(this).width()))})})}}]);app.controller("homeCtrl",["$http","$rootScope","$scope","$timeout","initialJSON",function(e,b,a,f,g){var h=this;h.len="...";b.$on("$locationChangeStart",function(b){a.master.routeChanged=!0});a.master.loc="Thorin-Games \u2014 The best place on the internet to play Flash and HTML5 games";a.master.desc="Welcome to Thorin-Games. Here you can find a broad selection of flash and html5 games sorted by popularity and category.";a.master.norsk&&(a.master.loc="Thorin-Games \u2014 Den beste siden p\u00e5 internett for \u00e5 spille Flash og HTML5 spill",
a.master.desc="Velkommen til Thorin-Games sin nettside. Her kan du finne nesten 2000 spill, sortert etter bl.a. kategori og hvor godt likt de er.");g.json.then(function(b){h.len=b.count;try{if(a.master.norsk){for(var c="",d=0;8>d;d++)c+=b.topTags[d].name+" ("+b.topTags[d].amount+" spill), ";c+=b.topTags[8].name+" ("+b.topTags[8].amount+" spill).";a.master.desc+=" De st\u00f8rste kategoriene akkurat n\u00e5 er "+c}else{c="";for(d=0;8>d;d++)c+=b.topTags[d].name+" ("+b.topTags[d].amount+" games), ";
c+=b.topTags[8].name+" ("+b.topTags[8].amount+" games).";a.master.desc+=" Our top categories right now are "+c}c="";for(d=0;7>d;d++)c+=" "+b.initialGames[d].title+" ("+b.initialGames[d].likes+" likes),";c+=" "+b.initialGames[7].title+" ("+b.initialGames[7].likes+" likes)";a.master.desc=a.master.norsk?a.master.desc+(" De mest popul\u00e6re spillene v\u00e5re n\u00e5 er"+c):a.master.desc+(" Our most popular games right now are"+c)}catch(k){console.warn(k)}})}]);app.service("local",[function(){var e=this;e.supported="undefined"!==typeof Storage;e.set=function(a,b,e){localStorage[a]="undefined"!==typeof e?JSON.stringify({str:b,expirationDate:e}):JSON.stringify({str:b})};e.get=function(a){if(e.keyExist(a))return JSON.parse(localStorage[a]).str};e.setExpiration=function(a,b){var e=JSON.parse(localStorage[a]);e.expirationDate=b;localStorage[a]=JSON.stringify(e)};e.getExpiration=function(a){return"undefined"!==typeof JSON.parse(localStorage[a]).expirationDate?
