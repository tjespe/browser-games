app.controller('submitCtrl', ['$http', '$scope', 'initialJSON', 'urls', function ($http, $scope, initialJSON, urls) {
  var vm = this;
  $scope.master.loc = "Tekiplay — Submit a game";
  $scope.master.desc = "If you want to, you can submit a game to Tekiplay, all you have to do is to fill out the form below and tap submit";
  if ($scope.master.norsk) {
    $scope.master.loc = "Tekiplay — Legg til et spill";
    $scope.master.desc = "Dersom du \u00f8nsker det kan du legge til et spill til Tekiplay. Alt du m\u00e5 gj\u00f8re er \u00e5 fylle ut skjemaet nedenfor og trykke legg til.";
  }
